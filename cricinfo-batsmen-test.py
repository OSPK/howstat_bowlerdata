...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///test-batsmen-cricinfo.db'
db = SQLAlchemy(app)
...
# Fetch from Cricinfo
def get_page(page):
    url = "http://stats.espncricinfo.com/ci/engine/stats/index.html?class=1;filter=advanced;orderby=runs;page={};size=200;template=results;type=batting".format(page)
    return url
