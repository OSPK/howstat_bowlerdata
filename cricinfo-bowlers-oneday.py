...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///oneday-bowlers-cricinfo.db'
db = SQLAlchemy(app)
...
# Fetch from Cricinfo
def get_page(page):
    url = "http://stats.espncricinfo.com/ci/engine/stats/index.html?class=2;filter=advanced;orderby=wickets;page={};size=200;template=results;type=bowling".format(page)
    return url
